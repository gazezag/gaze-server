import { o as onMounted, O as onBeforeUnmount, c as computed, a9 as createInjectionKey, P as inject, b as ref, M as useMemo, d as defineComponent, a0 as provide, ay as getCurrentInstance, E as withDirectives, aC as CssRender, J as useSsrAdapter, Y as watch, Z as nextTick, W as toRef, aD as isMounted, j as h, aE as getNative, r as root, aF as overArg, aG as isPrototype, aH as isArrayLike, aI as arrayLikeKeys, aJ as isArray, i as isSymbol, aK as MapCache, t as toString, aL as toSource, aM as baseGetTag, aN as Map, aO as Symbol$1, aP as eq, aQ as Uint8Array, aR as isBuffer, aS as Stack, aT as isTypedArray, aU as isObjectLike, a as isObject, aV as isLength, aW as isIndex, aX as isArguments, aY as identity, aZ as baseFor, a_ as arrayMap, U as c$1, e as cB, V as cNotM, f as cE, S as cM, a$ as cCB, u as useConfig, g as useTheme, a8 as popoverLight, w as watchEffect, F as vShow, h as useThemeClass, T as Transition, N as mergeProps, aq as Fragment, b0 as cloneVNode, B as createTextVNode, b1 as typographyLight, $ as createKey, C as createElementBlock, z as openBlock, D as createBaseVNode } from "./main-b154a3fa.js";
import { i as isBrowser, m as modalBodyInjectionKey, d as drawerBodyInjectionKey, p as popoverBodyInjectionKey, o as on, b as off, g as getSlot, c as getFirstVNode, z as zindexable, L as LazyTeleport, e as clickoutside, f as formatLength, F as FocusTrap, X as XScrollbar, h as getFirstSlotVNode, k as keep } from "./Icon-eb094341.js";
import { i as isSlotEmpty, r as resolveWrappedSlot, c as call } from "./Space-025b428f.js";
...
var dataViewCtorString = toSource(DataView$1), mapCtorString = toSource(Map), promiseCtorString = toSource(Promise$2), setCtorString = toSource(Set$2), weakMapCtorString = toSource(WeakMap$2);
var getTag = baseGetTag;
if (DataView$1 && getTag(new DataView$1(new ArrayBuffer(1))) != dataViewTag$1 || Map && getTag(new Map()) != mapTag$1 || Promise$2 && getTag(Promise$2.resolve()) != promiseTag || Set$2 && getTag(new Set$2()) != setTag$1 || WeakMap$2 && getTag(new WeakMap$2()) != weakMapTag) {
...
export {
  ...
  internalSelectionMenuBodyInjectionKey as d,
  VTarget as e,
  VFollower as f,
