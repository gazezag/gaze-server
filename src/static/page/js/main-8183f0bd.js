...
const getNow$1 = () => cachedNow || (p.then(reset), cachedNow = _getNow());
...
const getCurrentIntervalIdx = () => {
  ...
  weekDays.some((time, i) => {
    if (now2 >= time && now2 <= weekDays[i + 1]) {
      idx = i;
      return true;
    }
    return false;
...
const useResourceFlowStore = defineStore("resourceFlow", () => {
  ...
  const calculatedObj = computed(() => {
    const classifiedObj = resourceFlowList.value.reduce(
      (classifiedObj2, flowList) => {
        if (flowList) {
          flowList.forEach((item) => {
            const type = item.initiatorType;
            if (has(classifiedObj2, type)) {
              get(classifiedObj2, type).push(item);
            } else {
              set(classifiedObj2, type, [item]);
            }
          });
        }
        return classifiedObj2;
      },
      {}
    );
...
const getObjectListAverage = (objList) => {
  console.log(objList);
  return getKeys(objList[0]).filter((k) => typeof get(objList[0], k) === "number").reduce((r, k) => {
    set(
      r,
      k,
...
const mergeObjectList = (stuffList) => {
...
const routes = [
  { path: "/", redirect: "/overview" },
  {
    path: "/overview",
    name: "Overview",
    component: () => __vitePreload(() => import("./index-d712711e.js"), true ? ["index-d712711e.js","../css/index-d382d660.css","Panel-fa01c47f.js","../css/Panel-69551513.css","Space-2ff10da0.js","index-998b0633.js","Icon-6c59cc46.js","use-merged-state-12c965db.js","fade-in-width-expand.cssr-985ca46b.js","MainHeader-f8cbd45b.js","../css/MainHeader-e6262d5e.css","WarningOutline-09a89e98.js"] : void 0, import.meta.url)
  },
  {
    path: "/layout",
    name: "Layout",
    component: () => __vitePreload(() => import("./index-9cc8eb2e.js"), true ? ["index-9cc8eb2e.js","../css/index-127afcc7.css","Icon-6c59cc46.js","Space-2ff10da0.js","use-merged-state-12c965db.js","MainHeader-f8cbd45b.js","../css/MainHeader-e6262d5e.css","WarningOutline-09a89e98.js","fade-in-width-expand.cssr-985ca46b.js","ChevronRight-3423c6fb.js","Tooltip-d8500f9b.js"] : void 0, import.meta.url),
    beforeEnter: () => {
    ...
    children: [
      { path: "", redirect: "/performance-timing" },
      {
        ...
        component: () => __vitePreload(() => import("./index-e2c6ca91.js"), true ? ["index-e2c6ca91.js","../css/index-8e246c6e.css","Panel-fa01c47f.js","../css/Panel-69551513.css","Space-2ff10da0.js","WarningOutline-09a89e98.js","Icon-6c59cc46.js","use-merged-state-12c965db.js","Tooltip-d8500f9b.js"] : void 0, import.meta.url)
      },
      {
        path: "/navigation-timing",
        name: "NavigationTiming",
        component: () => __vitePreload(() => import("./index-8655aabd.js"), true ? ["index-8655aabd.js","../css/index-b3902dd9.css","Panel-fa01c47f.js","../css/Panel-69551513.css","Space-2ff10da0.js","index-998b0633.js"] : void 0, import.meta.url)
      },
      {
        path: "/resource-flow",
        name: "ResourseFlow",
        component: () => __vitePreload(() => import("./index-8d1d621c.js"), true ? ["index-8d1d621c.js","../css/index-daef3dc2.css","Panel-fa01c47f.js","../css/Panel-69551513.css","Space-2ff10da0.js","index-998b0633.js"] : void 0, import.meta.url)
      },
      {
        path: "/user-behavior",
        name: "UserBehavior",
        component: () => __vitePreload(() => import("./index-0189d76f.js"), true ? ["index-0189d76f.js","../css/index-60a016d1.css","Panel-fa01c47f.js","../css/Panel-69551513.css","Space-2ff10da0.js","Table-ba738875.js","use-merged-state-12c965db.js","ChevronRight-3423c6fb.js"] : void 0, import.meta.url)
      },
      {
        path: "/error-info",
        name: "ErrorInfo",
        component: () => __vitePreload(() => import("./index-05717f1f.js"), true ? ["index-05717f1f.js","../css/index-76c93b2b.css","fade-in-width-expand.cssr-985ca46b.js","Table-ba738875.js","Space-2ff10da0.js","use-merged-state-12c965db.js","ChevronRight-3423c6fb.js","Panel-fa01c47f.js","../css/Panel-69551513.css","Icon-6c59cc46.js"] : void 0, import.meta.url)
      }
    ]
  }
];
...
export {
  ...
  withDirectives as F,
  vShow as G,
  usePerformanceTimingStore as H,
  useErrorInfoStore as I,
  normalizeStyle as J,
  useSsrAdapter as K,
  onActivated as L,
  onDeactivated as M,
  ...
  cNotM as W,
  toRef as X,
  internalSelectMenuLight$1 as Y,
  watch as Z,
  _export_sfc as _,
  isObject$1 as a,
  arrayMap as a$,
  ...
  provide as a1,
  NBaseLoading as a2,
  commonVariables$m as a3,
  useStyle as a4,
  NFadeInExpandTransition as a5,
  TransitionGroup as a6,
  commonLight as a7,
  createTheme as a8,
  popoverLight$1 as a9,
  Teleport as aA,
  createId as aB,
  iconLight$1 as aC,
  CssRender as aD,
  ...
  cCB as b0,
  cloneVNode as b1,
  typographyLight$1 as b2,
  configProviderInjectionKey as b3,
  emptyLight$1 as b4,
  readonly as b5,
  dropdownLight as b6,
  ...
  useGlobal as n,
  onMounted as o,
  getWeekDaysLabel as p,
  getCurrentIntervalIdx as q,
  root$1 as r,
